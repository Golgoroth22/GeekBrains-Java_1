...
/**
 * Created by Валентин Фалин on 12.10.2016
 * Урок 3. Крестики-нолики в процедурном стиле.
 * Задание:
 * 1. Разобраться с кодом, подумать об оптимизации, попробовать переписать с нуля.
 * 2. Усовершенствовать метод проверки победы (например, через циклы).
 ...
 * Получилось сделать проверку ячеек по горизонтали и вертикали с помощью цикла.
 ...
 * Ну и для имитации раздумья бота добавил sleep на основную нить просто для красоты.
 */
